...
public class HumanoidActorActions : PersonActions
{
    ...
    public override void UseMount(MountActions mount)
    {
        ...
        highWallCheck.localPosition = new Vector3(highWallCheck.localPosition.x, highWallCheck.localPosition.y/2, highWallCheck.localPosition.z);
        frontWallCheck.localPosition = new Vector3(frontWallCheck.localPosition.x, frontWallCheck.localPosition.y/2, frontWallCheck.localPosition.z);
    }
