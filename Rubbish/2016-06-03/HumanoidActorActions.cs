...
public class HumanoidActorActions : PersonActions
{
    ...
    {
        SetMaxSpeed(defRunSpeed);
        lowWallCheck.parent.transform.localScale = new Vector3(transform.localScale.x, 0.6712638f, transform.localScale.z);
    ...
    {
        Debug.Log("садимся на маунта");
        lowWallCheck.parent.transform.localScale = new Vector3(lowWallCheck.parent.transform.localScale.x, lowWallCheck.parent.transform.localScale.y*mount.height, lowWallCheck.parent.transform.localScale.z);
        transform.position += new Vector3(0f, 10f, 0f);
        SetMaxSpeed(mount.tameSpeed);
        secondaryWeapon = mount.weapon;
        CharacterAnimator anim = GetComponentInChildren<CharacterAnimator>();
        List<PartController> childs = new List<PartController>();
        Debug.Log(mount.part);
        Debug.Log(childs);
        Debug.Log(anim);
